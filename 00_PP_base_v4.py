            ...
            if extra_toppings == "yes":
                ...
                while True:
                    ...
                    if topping_choice == 0:
                        ...
                        topping_name = list(topping_options.keys())[topping_choice - 1]
                        total_price += topping_options[topping_name] * quantity
                    else:
...
print_order_summary(expense_frame, delivery, sub_total)